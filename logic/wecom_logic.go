...
// 通过企业微信获取部门信息
func (d *WeComLogic) SyncWeComDepts(c *gin.Context, req any) (data any, rspError any) {
	// 1.获取所有部门
...
func (d WeComLogic) SyncWeComUsers(c *gin.Context, req any) (data any, rspError any) {
	// 1.获取企业微信用户列表
